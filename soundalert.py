...
soundalert_active = True

def alertsoff(word, word_eol, userdata):
...
def alertson(word, word_eol, userdata):
...
hexchat.hook_command("alertson", alertson, help="Turns on soundalert alerts.")
hexchat.hook_command("alertsoff", alertsoff, help="Turns off soundalert alerts.")
